...
def getGesture(isStraight_list):
    if isStraight_list[0] == 0 and isStraight_list[1] == 1 and isStraight_list[2] == 0 and isStraight_list[3] == 0 and \
            isStraight_list[4] == 0:
        gesture = "one"
    elif isStraight_list[0] == 0 and isStraight_list[1] == 1 and isStraight_list[2] == 1 and isStraight_list[3] == 0 and \
            isStraight_list[4] == 0:
        gesture = "two"
    elif isStraight_list[0] == 0 and isStraight_list[1] == 0 and isStraight_list[2] == 1 and isStraight_list[3] == 1 and \
            isStraight_list[4] == 1:
        gesture = "three"
    elif isStraight_list[0] == 0 and isStraight_list[1] == 1 and isStraight_list[2] == 1 and isStraight_list[3] == 1 and \
            isStraight_list[4] == 1:
        gesture = "four"
    elif isStraight_list[0] == 1 and isStraight_list[1] == 1 and isStraight_list[2] == 1 and isStraight_list[3] == 1 and \
            isStraight_list[4] == 1:
        gesture = "five"
    else:
        gesture = "None"
...
# 根据五根手指伸直程度识别手势(石头剪刀布)
def getGesture2(isStraight_list):
    if isStraight_list[0] == 0 and isStraight_list[1] == 0 and isStraight_list[2] == 0 and isStraight_list[3] == 0 and \
            isStraight_list[4] == 0:
        gesture = 1
    elif isStraight_list[0] == 0 and isStraight_list[1] == 1 and isStraight_list[2] == 1 and isStraight_list[3] == 0 and \
            isStraight_list[4] == 0:
...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
        ...
        image7 = cv2.imread("black.jpg")
        # 石头剪刀布
        gesture2 = getGesture2(isStraight_list)
        if gesture2 == 1:
            image7 = cv2.imread("shitou.jpg")
        elif gesture2 == 2:
            image7 = cv2.imread("jiandao.jpg")
        elif gesture2 == 3:
            image7 = cv2.imread("bu.jpg")
        else:
            image7 = cv2.imread("bu.jpg")
    ...
    try:
        ...
        image7 = cv2.resize(image7, (600, 400))
        result2show = np.hstack([image7, img])
        cv2.imshow("Image", result2show)
        cv2.waitKey(1)
    except:
        pass
